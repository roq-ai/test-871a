...
import { getAdministrationById } from 'apiSdk/administrations';
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('administration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/administrations/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="administration" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
