...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'product.create': {
    roles: ['administrator'],
    key: 'new-product-added',
    tenantPath: ['administration', 'user', 'product'],
    userPath: [],
  },
  'product.update': {
    roles: ['administrator'],
  ...
  'reservation.create': {
    roles: ['administrator', 'product-owner'],
    key: 'new-reservation-made',
    tenantPath: ['administration', 'user', 'reservation'],
    userPath: [],
  },
  'purchase.create': {
    roles: ['administrator'],
    key: 'new-purchase-made',
    tenantPath: ['administration', 'user', 'purchase'],
    userPath: [],
  },
  'review.create': {
    roles: ['administrator'],
    key: 'new-review-posted',
    tenantPath: ['administration', 'user', 'review'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['administrator', 'product-owner'];
...
export async function notificationHandlerMiddleware(req: NextApiRequest, entityId: string) {
  ...
  const tenant = await prisma.administration.findFirst({
